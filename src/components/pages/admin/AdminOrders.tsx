...
const AdminOrders: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const orderRes = await fetch('https://be-webdoluuniem.onrender.com/api/v1/orders', {
        ...
        const returnRes = await fetch('https://be-webdoluuniem.onrender.com/api/v1/returns', {
          headers: { Authorization: `Bearer ${token}` },
        });
  ...
  try {
    ...
    const response = await fetch(`https://be-webdoluuniem.onrender.com/api/v1/returns/by-order/${orderId}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
