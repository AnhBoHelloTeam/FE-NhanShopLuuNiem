...
const CategoryManagement = () => {
    ...
    try {
      ...
      if (editingCategory) {
        ...
        const response = await fetch(
          `https://be-webdoluuniem.onrender.com/api/v1/categories/${editingCategory._id}`,
          {
            method: "PUT",
            headers: {
              "Content-Type": "application/json",
  ...
  const handleDeleteCategory = async (categoryId: string) => {
    ...
    try {
      const response = await fetch(`https://be-webdoluuniem.onrender.com/api/v1/categories/${categoryId}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
